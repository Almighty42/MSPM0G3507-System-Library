...
#define SYSCTL_WRITELOCK_OFFSET      0x1200UL   /* confirmed */
#define SYSCTL_MCLKCFG_OFFSET        0x1104UL   /* TODO: verify */
#define SYSCTL_SYSPLLCFG0_OFFSET     0x1120UL   /* TODO: verify */
#define SYSCTL_SYSPLLCFG1_OFFSET     0x1124UL   /* TODO: verify */
#define SYSCTL_SYSPLLPARAM0_OFFSET   0x1128UL   /* TODO: verify */
#define SYSCTL_SYSPLLPARAM1_OFFSET   0x112CUL   /* TODO: verify */
#define SYSCTL_HSCLKEN_OFFSET        0x1108UL   /* TODO: verify */
#define SYSCTL_HSCLKCFG_OFFSET       0x110CUL   /* TODO: verify */
#define SYSCTL_CLKSTATUS_OFFSET      0x1204UL   /* TODO: verify */

#define SYSCTL_WRITELOCK      (*(volatile uint32_t *)(SYSCTL_BASE + SYSCTL_WRITELOCK_OFFSET))
#define SYSCTL_MCLKCFG        (*(volatile uint32_t *)(SYSCTL_BASE + SYSCTL_MCLKCFG_OFFSET))
#define SYSCTL_SYSPLLCFG0     (*(volatile uint32_t *)(SYSCTL_BASE + SYSCTL_SYSPLLCFG0_OFFSET))
#define SYSCTL_SYSPLLCFG1     (*(volatile uint32_t *)(SYSCTL_BASE + SYSCTL_SYSPLLCFG1_OFFSET))
#define SYSCTL_SYSPLLPARAM0   (*(volatile uint32_t *)(SYSCTL_BASE + SYSCTL_SYSPLLPARAM0_OFFSET))
#define SYSCTL_SYSPLLPARAM1   (*(volatile uint32_t *)(SYSCTL_BASE + SYSCTL_SYSPLLPARAM1_OFFSET))
#define SYSCTL_HSCLKEN        (*(volatile uint32_t *)(SYSCTL_BASE + SYSCTL_HSCLKEN_OFFSET))
#define SYSCTL_HSCLKCFG       (*(volatile uint32_t *)(SYSCTL_BASE + SYSCTL_HSCLKCFG_OFFSET))
#define SYSCTL_CLKSTATUS      (*(volatile uint32_t *)(SYSCTL_BASE + SYSCTL_CLKSTATUS_OFFSET))
...
void SystemInit(void)
{
    ...
    // SYSCTL_MCLKCFG &= ~(0xFU << SYSCTL_MCLKCFG_FLASHWAIT);   // correct 4-bit clear
    // SYSCTL_MCLKCFG |= (2U << SYSCTL_MCLKCFG_FLASHWAIT);       // harmless now per TRM, but correct going forward

    // 1. Verify that the SYSPLL is disabled (SYSPLLOFF is set in CLKSTATUS)
    if (!(SYSCTL_CLKSTATUS & (1UL << SYSCTL_CLKSTATUS_SYSPLLOFF))) {
        return;
    }
    ...
    SYSCTL_SYSPLLCFG1 = (SYSCTL_SYSPLLCFG1 & ~(0xFU << SYSCTL_SYSPLLCFG1_PDIV))
    ...
    SYSCTL_SYSPLLCFG1 = (SYSCTL_SYSPLLCFG1 & ~(0xFU << SYSCTL_SYSPLLCFG1_QDIV))
                       | (4U << SYSCTL_SYSPLLCFG1_QDIV);

    // 7. Set output dividers: RDIVCLK1 = 0, RDIVCLK2X = 1
    SYSCTL_SYSPLLCFG0 = (SYSCTL_SYSPLLCFG0 & ~(0xFU << SYSCTL_SYSPLLCFG0_RDIVCLK1))
                       | (0U << SYSCTL_SYSPLLCFG0_RDIVCLK1);
    SYSCTL_SYSPLLCFG0 = (SYSCTL_SYSPLLCFG0 & ~(0xFU << SYSCTL_SYSPLLCFG0_RDIVCLK2X))
